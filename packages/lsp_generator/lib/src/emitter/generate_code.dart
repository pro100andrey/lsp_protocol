  ...
  if (dir.packageName == 'pro_lsp') {
    final clientBarrelLib = Library(
      (b) => b
        ..comments.add('GENERATED — do not edit.')
        ..directives.addAll([
          .export(GeneratedPaths.modelExport(Files.structures)),
          .export(GeneratedPaths.modelExport(Files.enumerations)),
          .export(GeneratedPaths.modelExport(Files.aliases)),
          .export(GeneratedPaths.modelExport(Files.scalarUnions)),
          .export(GeneratedPaths.modelExport(Files.unions)),
          .export(GeneratedPaths.modelExport(Files.methods)),
