...
ArrayRef _$ArrayRefFromJson(Map<String, dynamic> json) => ArrayRef(
  kind: $enumDecode(_$TypeKindEnumMap, json['kind']),
...
OrRef _$OrRefFromJson(Map<String, dynamic> json) => OrRef(
  kind: $enumDecode(_$TypeKindEnumMap, json['kind']),
...
TupleRef _$TupleRefFromJson(Map<String, dynamic> json) => TupleRef(
  kind: $enumDecode(_$TypeKindEnumMap, json['kind']),
  items: (json['items'] as List<dynamic>)
      .map((e) => MetaReference.fromJson(e as Map<String, dynamic>))
      .toList(),
...
_MetaEnumMember _$MetaEnumMemberFromJson(Map<String, dynamic> json) =>
    _MetaEnumMember(
      name: json['name'] as String,
      value: const IntOrStringSealedConverter().fromJson(
