...
extension ProgressTokenPatterns on ProgressToken {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(ProgressToken$Int value)? int,
    TResult Function(ProgressToken$String value)? string,
    ...
    switch (_that) {
      case ProgressToken$Int() when int != null:
        return int(_that);
      case ProgressToken$String() when string != null:
        return string(_that);
      case _:
        return orElse();
    }
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(ProgressToken$Int value) int,
    required TResult Function(ProgressToken$String value) string,
  }) {
    final _that = this;
    switch (_that) {
      case ProgressToken$Int():
        return int(_that);
      case ProgressToken$String():
        return string(_that);
    }
  }
...
class ProgressToken$Int extends ProgressToken {
  ...
  $ProgressToken$IntCopyWith<ProgressToken$Int> get copyWith =>
      _$ProgressToken$IntCopyWithImpl<ProgressToken$Int>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ProgressToken$Int &&
...
/// @nodoc
abstract mixin class $ProgressToken$IntCopyWith<$Res>
    implements $ProgressTokenCopyWith<$Res> {
  factory $ProgressToken$IntCopyWith(
          ProgressToken$Int value, $Res Function(ProgressToken$Int) _then) =
      _$ProgressToken$IntCopyWithImpl;
  @useResult
  $Res call({int value});
}
...
class ProgressToken$String extends ProgressToken {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ProgressToken$StringCopyWith<ProgressToken$String> get copyWith =>
      _$ProgressToken$StringCopyWithImpl<ProgressToken$String>(
          this, _$identity);
...
/// @nodoc
abstract mixin class $ProgressToken$StringCopyWith<$Res>
    implements $ProgressTokenCopyWith<$Res> {
  factory $ProgressToken$StringCopyWith(ProgressToken$String value,
          $Res Function(ProgressToken$String) _then) =
      _$ProgressToken$StringCopyWithImpl;
  @useResult
