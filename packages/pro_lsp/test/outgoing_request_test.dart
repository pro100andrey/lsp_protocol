...
void main() {
  group('LspConnection.sendRequest (outgoing)', () {
    ...
    test('maps a peer error response to LspException with code/message/data',
        () async {
    ...
    test(r'token cancellation sends $/cancelRequest with the request id', () async {
    ...
    test(r'timeout sends $/cancelRequest and throws requestCancelled', () async {
      final cancelSent = nextMessage(r'$/cancelRequest');
      final future = connection.sendRequest(
        RequestMethod.hover,
        {'a': 1},
    ...
    test('concurrent requests get distinct ids and resolve independently',
        () async {
