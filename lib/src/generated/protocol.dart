...
typedef Definition = DeclarationSealed;
...
/// @since 3.17.0
typedef InlineValue = InlineValueSealed;
...
typedef PrepareRenameResult = PrepareRenameResultSealed;
...
typedef ProgressToken = ProgressTokenSealed;
...
typedef TextDocumentContentChangeEvent = TextDocumentContentChangeEventSealed;
...
sealed class DeclarationSealed {
  const DeclarationSealed();
}

final class DeclarationSealed0 extends DeclarationSealed {
  const DeclarationSealed0();
}

final class DeclarationSealed1 extends DeclarationSealed {
  const DeclarationSealed1();
}

sealed class LSPAnySealed {
  const LSPAnySealed();
}

final class LSPAnySealed0 extends LSPAnySealed {
  const LSPAnySealed0();
}

final class LSPAnySealed1 extends LSPAnySealed {
  const LSPAnySealed1();
}

final class LSPAnySealed2 extends LSPAnySealed {
  const LSPAnySealed2();
}

final class LSPAnySealed3 extends LSPAnySealed {
  const LSPAnySealed3();
}

final class LSPAnySealed4 extends LSPAnySealed {
  const LSPAnySealed4();
}

final class LSPAnySealed5 extends LSPAnySealed {
  const LSPAnySealed5();
}

final class LSPAnySealed6 extends LSPAnySealed {
  const LSPAnySealed6();
}

final class LSPAnySealed7 extends LSPAnySealed {
  const LSPAnySealed7();
}

sealed class InlineValueSealed {
  const InlineValueSealed();
}

final class InlineValueSealed0 extends InlineValueSealed {
  const InlineValueSealed0();
}

final class InlineValueSealed1 extends InlineValueSealed {
  const InlineValueSealed1();
}

final class InlineValueSealed2 extends InlineValueSealed {
  const InlineValueSealed2();
}
...
final class DocumentDiagnosticReportSealed0
    extends DocumentDiagnosticReportSealed {
  const DocumentDiagnosticReportSealed0();
}

final class DocumentDiagnosticReportSealed1
    extends DocumentDiagnosticReportSealed {
  const DocumentDiagnosticReportSealed1();
}

sealed class PrepareRenameResultSealed {
  const PrepareRenameResultSealed();
}

final class PrepareRenameResultSealed0 extends PrepareRenameResultSealed {
  const PrepareRenameResultSealed0();
}

final class PrepareRenameResultSealed1 extends PrepareRenameResultSealed {
  const PrepareRenameResultSealed1();
}

final class PrepareRenameResultSealed2 extends PrepareRenameResultSealed {
  const PrepareRenameResultSealed2();
}

sealed class ProgressTokenSealed {
  const ProgressTokenSealed();
}

final class ProgressTokenSealed0 extends ProgressTokenSealed {
  const ProgressTokenSealed0();
}

final class ProgressTokenSealed1 extends ProgressTokenSealed {
  const ProgressTokenSealed1();
}
...
final class WorkspaceDocumentDiagnosticReportSealed0
    extends WorkspaceDocumentDiagnosticReportSealed {
  const WorkspaceDocumentDiagnosticReportSealed0();
}

final class WorkspaceDocumentDiagnosticReportSealed1
    extends WorkspaceDocumentDiagnosticReportSealed {
  const WorkspaceDocumentDiagnosticReportSealed1();
}

sealed class TextDocumentContentChangeEventSealed {
  const TextDocumentContentChangeEventSealed();
}

final class TextDocumentContentChangeEventSealed0
    extends TextDocumentContentChangeEventSealed {
  const TextDocumentContentChangeEventSealed0();
}

final class TextDocumentContentChangeEventSealed1
    extends TextDocumentContentChangeEventSealed {
  const TextDocumentContentChangeEventSealed1();
}
...
final class MarkedStringSealed0 extends MarkedStringSealed {
  const MarkedStringSealed0();
}

final class MarkedStringSealed1 extends MarkedStringSealed {
  const MarkedStringSealed1();
}
...
final class DocumentFilterSealed0 extends DocumentFilterSealed {
  const DocumentFilterSealed0();
}

final class DocumentFilterSealed1 extends DocumentFilterSealed {
  const DocumentFilterSealed1();
}
...
final class GlobPatternSealed0 extends GlobPatternSealed {
  const GlobPatternSealed0();
}

final class GlobPatternSealed1 extends GlobPatternSealed {
  const GlobPatternSealed1();
}
...
final class TextDocumentFilterSealed0 extends TextDocumentFilterSealed {
  const TextDocumentFilterSealed0();
}

final class TextDocumentFilterSealed1 extends TextDocumentFilterSealed {
  const TextDocumentFilterSealed1();
}

final class TextDocumentFilterSealed2 extends TextDocumentFilterSealed {
  const TextDocumentFilterSealed2();
}
...
final class NotebookDocumentFilterSealed0 extends NotebookDocumentFilterSealed {
  const NotebookDocumentFilterSealed0();
}

final class NotebookDocumentFilterSealed1 extends NotebookDocumentFilterSealed {
  const NotebookDocumentFilterSealed1();
}

final class NotebookDocumentFilterSealed2 extends NotebookDocumentFilterSealed {
  const NotebookDocumentFilterSealed2();
}
...
final class DocumentSelectorSealed0 extends DocumentSelectorSealed {
  const DocumentSelectorSealed0();
}

final class DocumentSelectorSealed1 extends DocumentSelectorSealed {
  const DocumentSelectorSealed1();
}
...
final class DocumentChangeSealed0 extends DocumentChangeSealed {
  const DocumentChangeSealed0();
}

final class DocumentChangeSealed1 extends DocumentChangeSealed {
  const DocumentChangeSealed1();
}

final class DocumentChangeSealed2 extends DocumentChangeSealed {
  const DocumentChangeSealed2();
}

final class DocumentChangeSealed3 extends DocumentChangeSealed {
  const DocumentChangeSealed3();
}
...
final class HintLabelSealed0 extends HintLabelSealed {
  const HintLabelSealed0();
}

final class HintLabelSealed1 extends HintLabelSealed {
  const HintLabelSealed1();
}

sealed class DocumentationSealed {
  const DocumentationSealed();
}

final class DocumentationSealed0 extends DocumentationSealed {
  const DocumentationSealed0();
}

final class DocumentationSealed1 extends DocumentationSealed {
  const DocumentationSealed1();
}

sealed class FullDocumentDiagnosticReportSealed {
  const FullDocumentDiagnosticReportSealed();
}

final class FullDocumentDiagnosticReportSealed0
    extends FullDocumentDiagnosticReportSealed {
  const FullDocumentDiagnosticReportSealed0();
}

final class FullDocumentDiagnosticReportSealed1
    extends FullDocumentDiagnosticReportSealed {
  const FullDocumentDiagnosticReportSealed1();
}
...
final class InsertTextSealed0 extends InsertTextSealed {
  const InsertTextSealed0();
}

final class InsertTextSealed1 extends InsertTextSealed {
  const InsertTextSealed1();
}

sealed class RegistrationOptionsSectionSealed {
  const RegistrationOptionsSectionSealed();
}

final class RegistrationOptionsSectionSealed0
    extends RegistrationOptionsSectionSealed {
  const RegistrationOptionsSectionSealed0();
}

final class RegistrationOptionsSectionSealed1
    extends RegistrationOptionsSectionSealed {
  const RegistrationOptionsSectionSealed1();
}
...
final class TextEditSealed0 extends TextEditSealed {
  const TextEditSealed0();
}

final class TextEditSealed1 extends TextEditSealed {
  const TextEditSealed1();
}
...
final class EditRangeSealed0 extends EditRangeSealed {
  const EditRangeSealed0();
}

final class EditRangeSealed1 extends EditRangeSealed {
  const EditRangeSealed1();
}

sealed class HoverContentsSealed {
  const HoverContentsSealed();
}

final class HoverContentsSealed0 extends HoverContentsSealed {
  const HoverContentsSealed0();
}

final class HoverContentsSealed1 extends HoverContentsSealed {
  const HoverContentsSealed1();
}

final class HoverContentsSealed2 extends HoverContentsSealed {
  const HoverContentsSealed2();
}
...
final class SymbolLocationSealed0 extends SymbolLocationSealed {
  const SymbolLocationSealed0();
}

final class SymbolLocationSealed1 extends SymbolLocationSealed {
  const SymbolLocationSealed1();
}
...
final class SemanticTokensRangeSealed0 extends SemanticTokensRangeSealed {
  const SemanticTokensRangeSealed0();
}

final class SemanticTokensRangeSealed1 extends SemanticTokensRangeSealed {
  const SemanticTokensRangeSealed1();
}

sealed class SemanticTokensFullSealed {
  const SemanticTokensFullSealed();
}

final class SemanticTokensFullSealed0 extends SemanticTokensFullSealed {
  const SemanticTokensFullSealed0();
}

final class SemanticTokensFullSealed1 extends SemanticTokensFullSealed {
  const SemanticTokensFullSealed1();
}

sealed class EditSealed {
  const EditSealed();
}

final class EditSealed0 extends EditSealed {
  const EditSealed0();
}

final class EditSealed1 extends EditSealed {
  const EditSealed1();
}

sealed class VersionOrIdSealed {
  const VersionOrIdSealed();
}

final class VersionOrIdSealed0 extends VersionOrIdSealed {
  const VersionOrIdSealed0();
}

final class VersionOrIdSealed1 extends VersionOrIdSealed {
  const VersionOrIdSealed1();
}

sealed class RootPathSealed {
  const RootPathSealed();
}

final class RootPathSealed0 extends RootPathSealed {
  const RootPathSealed0();
}

final class RootPathSealed1 extends RootPathSealed {
  const RootPathSealed1();
}

sealed class WorkspaceFoldersSealed {
  const WorkspaceFoldersSealed();
}

final class WorkspaceFoldersSealed0 extends WorkspaceFoldersSealed {
  const WorkspaceFoldersSealed0();
}

final class WorkspaceFoldersSealed1 extends WorkspaceFoldersSealed {
  const WorkspaceFoldersSealed1();
}
...
final class TextDocumentSyncSealed0 extends TextDocumentSyncSealed {
  const TextDocumentSyncSealed0();
}

final class TextDocumentSyncSealed1 extends TextDocumentSyncSealed {
  const TextDocumentSyncSealed1();
}
...
final class NotebookDocumentSyncSealed0 extends NotebookDocumentSyncSealed {
  const NotebookDocumentSyncSealed0();
}

final class NotebookDocumentSyncSealed1 extends NotebookDocumentSyncSealed {
  const NotebookDocumentSyncSealed1();
}
...
final class HoverProviderSealed0 extends HoverProviderSealed {
  const HoverProviderSealed0();
}

final class HoverProviderSealed1 extends HoverProviderSealed {
  const HoverProviderSealed1();
}
...
final class DeclarationProviderSealed0 extends DeclarationProviderSealed {
  const DeclarationProviderSealed0();
}

final class DeclarationProviderSealed1 extends DeclarationProviderSealed {
  const DeclarationProviderSealed1();
}

final class DeclarationProviderSealed2 extends DeclarationProviderSealed {
  const DeclarationProviderSealed2();
}
...
final class DefinitionProviderSealed0 extends DefinitionProviderSealed {
  const DefinitionProviderSealed0();
}

final class DefinitionProviderSealed1 extends DefinitionProviderSealed {
  const DefinitionProviderSealed1();
}
...
final class TypeDefinitionProviderSealed0 extends TypeDefinitionProviderSealed {
  const TypeDefinitionProviderSealed0();
}

final class TypeDefinitionProviderSealed1 extends TypeDefinitionProviderSealed {
  const TypeDefinitionProviderSealed1();
}

final class TypeDefinitionProviderSealed2 extends TypeDefinitionProviderSealed {
  const TypeDefinitionProviderSealed2();
}
...
final class ImplementationProviderSealed0 extends ImplementationProviderSealed {
  const ImplementationProviderSealed0();
}

final class ImplementationProviderSealed1 extends ImplementationProviderSealed {
  const ImplementationProviderSealed1();
}

final class ImplementationProviderSealed2 extends ImplementationProviderSealed {
  const ImplementationProviderSealed2();
}
...
final class ReferencesProviderSealed0 extends ReferencesProviderSealed {
  const ReferencesProviderSealed0();
}

final class ReferencesProviderSealed1 extends ReferencesProviderSealed {
  const ReferencesProviderSealed1();
}
...
final class DocumentHighlightProviderSealed0
    extends DocumentHighlightProviderSealed {
  const DocumentHighlightProviderSealed0();
}

final class DocumentHighlightProviderSealed1
    extends DocumentHighlightProviderSealed {
  const DocumentHighlightProviderSealed1();
}
...
final class DocumentSymbolProviderSealed0 extends DocumentSymbolProviderSealed {
  const DocumentSymbolProviderSealed0();
}

final class DocumentSymbolProviderSealed1 extends DocumentSymbolProviderSealed {
  const DocumentSymbolProviderSealed1();
}
...
final class CodeActionProviderSealed0 extends CodeActionProviderSealed {
  const CodeActionProviderSealed0();
}

final class CodeActionProviderSealed1 extends CodeActionProviderSealed {
  const CodeActionProviderSealed1();
}
...
final class ColorProviderSealed0 extends ColorProviderSealed {
  const ColorProviderSealed0();
}

final class ColorProviderSealed1 extends ColorProviderSealed {
  const ColorProviderSealed1();
}

final class ColorProviderSealed2 extends ColorProviderSealed {
  const ColorProviderSealed2();
}
...
final class WorkspaceSymbolProviderSealed0
    extends WorkspaceSymbolProviderSealed {
  const WorkspaceSymbolProviderSealed0();
}

final class WorkspaceSymbolProviderSealed1
    extends WorkspaceSymbolProviderSealed {
  const WorkspaceSymbolProviderSealed1();
}
...
final class DocumentFormattingProviderSealed0
    extends DocumentFormattingProviderSealed {
  const DocumentFormattingProviderSealed0();
}

final class DocumentFormattingProviderSealed1
    extends DocumentFormattingProviderSealed {
  const DocumentFormattingProviderSealed1();
}
...
final class DocumentRangeFormattingProviderSealed0
    extends DocumentRangeFormattingProviderSealed {
  const DocumentRangeFormattingProviderSealed0();
}

final class DocumentRangeFormattingProviderSealed1
    extends DocumentRangeFormattingProviderSealed {
  const DocumentRangeFormattingProviderSealed1();
}
...
final class RenameProviderSealed0 extends RenameProviderSealed {
  const RenameProviderSealed0();
}

final class RenameProviderSealed1 extends RenameProviderSealed {
  const RenameProviderSealed1();
}
...
final class FoldingRangeProviderSealed0 extends FoldingRangeProviderSealed {
  const FoldingRangeProviderSealed0();
}

final class FoldingRangeProviderSealed1 extends FoldingRangeProviderSealed {
  const FoldingRangeProviderSealed1();
}

final class FoldingRangeProviderSealed2 extends FoldingRangeProviderSealed {
  const FoldingRangeProviderSealed2();
}
...
final class SelectionRangeProviderSealed0 extends SelectionRangeProviderSealed {
  const SelectionRangeProviderSealed0();
}

final class SelectionRangeProviderSealed1 extends SelectionRangeProviderSealed {
  const SelectionRangeProviderSealed1();
}

final class SelectionRangeProviderSealed2 extends SelectionRangeProviderSealed {
  const SelectionRangeProviderSealed2();
}
...
final class CallHierarchyProviderSealed0 extends CallHierarchyProviderSealed {
  const CallHierarchyProviderSealed0();
}

final class CallHierarchyProviderSealed1 extends CallHierarchyProviderSealed {
  const CallHierarchyProviderSealed1();
}

final class CallHierarchyProviderSealed2 extends CallHierarchyProviderSealed {
  const CallHierarchyProviderSealed2();
}
...
final class LinkedEditingRangeProviderSealed0
    extends LinkedEditingRangeProviderSealed {
  const LinkedEditingRangeProviderSealed0();
}

final class LinkedEditingRangeProviderSealed1
    extends LinkedEditingRangeProviderSealed {
  const LinkedEditingRangeProviderSealed1();
}

final class LinkedEditingRangeProviderSealed2
    extends LinkedEditingRangeProviderSealed {
  const LinkedEditingRangeProviderSealed2();
}
...
final class SemanticTokensProviderSealed0 extends SemanticTokensProviderSealed {
  const SemanticTokensProviderSealed0();
}

final class SemanticTokensProviderSealed1 extends SemanticTokensProviderSealed {
  const SemanticTokensProviderSealed1();
}
...
final class MonikerProviderSealed0 extends MonikerProviderSealed {
  const MonikerProviderSealed0();
}

final class MonikerProviderSealed1 extends MonikerProviderSealed {
  const MonikerProviderSealed1();
}

final class MonikerProviderSealed2 extends MonikerProviderSealed {
  const MonikerProviderSealed2();
}
...
final class TypeHierarchyProviderSealed0 extends TypeHierarchyProviderSealed {
  const TypeHierarchyProviderSealed0();
}

final class TypeHierarchyProviderSealed1 extends TypeHierarchyProviderSealed {
  const TypeHierarchyProviderSealed1();
}

final class TypeHierarchyProviderSealed2 extends TypeHierarchyProviderSealed {
  const TypeHierarchyProviderSealed2();
}
...
final class InlineValueProviderSealed0 extends InlineValueProviderSealed {
  const InlineValueProviderSealed0();
}

final class InlineValueProviderSealed1 extends InlineValueProviderSealed {
  const InlineValueProviderSealed1();
}

final class InlineValueProviderSealed2 extends InlineValueProviderSealed {
  const InlineValueProviderSealed2();
}
...
final class InlayHintProviderSealed0 extends InlayHintProviderSealed {
  const InlayHintProviderSealed0();
}

final class InlayHintProviderSealed1 extends InlayHintProviderSealed {
  const InlayHintProviderSealed1();
}

final class InlayHintProviderSealed2 extends InlayHintProviderSealed {
  const InlayHintProviderSealed2();
}
...
final class DiagnosticProviderSealed0 extends DiagnosticProviderSealed {
  const DiagnosticProviderSealed0();
}

final class DiagnosticProviderSealed1 extends DiagnosticProviderSealed {
  const DiagnosticProviderSealed1();
}
...
final class InlineCompletionProviderSealed0
    extends InlineCompletionProviderSealed {
  const InlineCompletionProviderSealed0();
}

final class InlineCompletionProviderSealed1
    extends InlineCompletionProviderSealed {
  const InlineCompletionProviderSealed1();
}
...
final class SaveSealed0 extends SaveSealed {
  const SaveSealed0();
}

final class SaveSealed1 extends SaveSealed {
  const SaveSealed1();
}

sealed class NotebookSealed {
  const NotebookSealed();
}

final class NotebookSealed0 extends NotebookSealed {
  const NotebookSealed0();
}

final class NotebookSealed1 extends NotebookSealed {
  const NotebookSealed1();
}
...
final class ChangeNotificationsSealed0 extends ChangeNotificationsSealed {
  const ChangeNotificationsSealed0();
}

final class ChangeNotificationsSealed1 extends ChangeNotificationsSealed {
  const ChangeNotificationsSealed1();
}

sealed class ParameterLabelSealed {
  const ParameterLabelSealed();
}

final class ParameterLabelSealed0 extends ParameterLabelSealed {
  const ParameterLabelSealed0();
}

final class ParameterLabelSealed1 extends ParameterLabelSealed {
  const ParameterLabelSealed1();
}
...
final class NotebookFilterSealed0 extends NotebookFilterSealed {
  const NotebookFilterSealed0();
}

final class NotebookFilterSealed1 extends NotebookFilterSealed {
  const NotebookFilterSealed1();
}

sealed class BaseUriSealed {
  const BaseUriSealed();
}

final class BaseUriSealed0 extends BaseUriSealed {
  const BaseUriSealed0();
}

final class BaseUriSealed1 extends BaseUriSealed {
  const BaseUriSealed1();
}
...
abstract class InitializeParams with _$InitializeParams {
  const factory InitializeParams({
    ...
    required VersionOrIdSealed processId,

    /// The rootPath of the workspace. Is null if no folder is open.
    /// @deprecated in favour of rootUri.
    RootPathSealed? rootPath,

    /// The rootUri of the workspace. Is null if no folder is open. If both
    /// `rootPath` and `rootUri` are set `rootUri` wins.
    /// @deprecated in favour of workspaceFolders.
    required RootPathSealed rootUri,
    ...
    /// none are configured.
    /// @since 3.6.0
    WorkspaceFoldersSealed? workspaceFolders,
  }) = _InitializeParams;
...
abstract class DidChangeConfigurationRegistrationOptions
  ...
  const factory DidChangeConfigurationRegistrationOptions({
    RegistrationOptionsSectionSealed? section,
...
abstract class CompletionItem with _$CompletionItem {
  const factory CompletionItem({
    ...
    DocumentationSealed? documentation,
...
abstract class Hover with _$Hover {
  const factory Hover({
    /// The hover's content
    required HoverContentsSealed contents,
...
abstract class CancelParams with _$CancelParams {
  const factory CancelParams({
    ...
    required ProgressTokenSealed id,
  }) = _CancelParams;
...
abstract class TextDocumentEdit with _$TextDocumentEdit {
  const factory TextDocumentEdit({
    ...
    /// client capability.
    required List<EditSealed> edits,
...
abstract class OptionalVersionedTextDocumentIdentifier
  ...
  const factory OptionalVersionedTextDocumentIdentifier({
    ...
    required VersionOrIdSealed version,
...
abstract class NotebookDocumentSyncOptions with _$NotebookDocumentSyncOptions {
  const factory NotebookDocumentSyncOptions({
    ...
    required List<NotebookSealed> notebookSelector,
...
abstract class ParameterInformation with _$ParameterInformation {
  const factory ParameterInformation({
    ...
    required ParameterLabelSealed label,
...
abstract class RelativePattern with _$RelativePattern {
  const factory RelativePattern({
    ...
    /// against relatively.
    required BaseUriSealed baseUri,
...
abstract class WorkspaceEditClientCapabilities
  ...
  const factory WorkspaceEditClientCapabilities({
    ...
    /// @since 3.16.0
    Literal21? changeAnnotationSupport,
...
abstract class CompletionClientCapabilities
  ...
  const factory CompletionClientCapabilities({
    ...
    /// capabilities.
    Literal27? completionItem,
    Literal28? completionItemKind,

    /// The client supports the following `CompletionList` specific
    /// capabilities.
    /// @since 3.17.0
    Literal29? completionList,
...
abstract class SignatureHelpClientCapabilities
  ...
  const factory SignatureHelpClientCapabilities({
    ...
    /// properties.
    Literal31? signatureInformation,
...
abstract class CodeActionClientCapabilities
  ...
  const factory CodeActionClientCapabilities({
    ...
    /// @since 3.8.0
    Literal33? codeActionLiteralSupport,
...
abstract class FoldingRangeClientCapabilities
  ...
  const factory FoldingRangeClientCapabilities({
    ...
    /// @since 3.17.0
    Literal35? foldingRange,

    /// Specific options for the folding range kind.
    /// @since 3.17.0
    Literal34? foldingRangeKind,
